...
{ 
	...
	{		
		...
		<button type="submit" name="prepa" class="btn btn-primary">Submit</button>
		</form>
		...
		if(isset($_GET["prepa"]))
		{
			...
			<input type="checkbox" name="paid" value="true" class="custom-control-input" id="customCheck1">
		...
		if(isset($_GET["create"]))
		{
			...
			$paid = (empty($_GET["paid"])) ? 'false' : htmlspecialchars($_GET["paid"]);
